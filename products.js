/* ===== Catálogo de maquinaria (fuente única de datos) =====
   ...
   detalle, que build.mjs genera como HTML estático en
   maquinaria/<slug>/index.html.

   slug: define la URL pública del equipo y NO conviene cambiarlo una vez
   publicado (cambiarlo rompe los enlaces que ya circulan).
...
const PRODUCTS = [
  ...
  },
  {
    ...
    alquilerDia: '100',
    alquilerSemana: '350',
    desc: 'Plataforma de tijera con desplazamiento a batería y caminar asistido. Incluye kit de elevación. Se mueve sin cables ni combustible, ideal para trabajos prolongados en interiores donde se necesita autonomía y bajo mantenimiento. Próximo ingreso: ya podés reservar tu unidad.',
    cardSpecs: [
  ...
  },
  {
    ...
    cuotasMax: 18,
    cuota: '153',
    desc: 'Plataforma de tijera con elevación eléctrica y desplazamiento manual. Amplia jaula de trabajo y gran capacidad de carga, pensada para obra e industria a un costo accesible. Próximo ingreso: ya podés reservar tu unidad.',
    cardSpecs: [
      ['bi-arrows-expand', '11 m'],
      ['bi-box-seam', '500 kg'],
      ['bi-lightning-charge-fill', '220 V'],
  ...
  },
  {
    ...
    slug: 'plataforma-electrica-autopropulsada-10m',
    brand: 'gradin',
  ...
  {
    id: 'facilcarga-12m',
    slug: 'plataforma-electrica-facil-carga-12m',
    brand: 'gradin',
  ...
  /* ===== HSY LIFT ===== */
  {
    ...
    icon: 'bi-layers',
    precio: '7.300',
    desc: 'Plataforma de tijera compacta y maniobrable (modelo SJYZM0406). Una sola persona puede empujarla, entra por pasillos estrechos y es apta para uso doméstico y comercial en interiores. Próximo ingreso: ya podés reservar tu unidad.',
    cardSpecs: [
  ...
  },
  {
    ...
    slug: 'plataforma-articulada-remolcable-14m',
    brand: 'hsylift',
    ...
    icon: 'bi-bezier2',
    precio: '21.990',
    desc: 'Plataforma articulada remolcable con brazo de gran alcance y rotación de 360°. Motor Honda a nafta, estabilizadores y desplazamiento por remolque. Ideal para mantenimiento, instalaciones eléctricas, poda y trabajos en altura en exteriores. Próximo ingreso: ya podés reservar tu unidad.',
    cardSpecs: [
